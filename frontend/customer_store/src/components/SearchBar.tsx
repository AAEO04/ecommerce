      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md leading-5 bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-accent-green focus:border-accent-green sm:text-sm"
          />
          {query && (
            <button
              type="button"
